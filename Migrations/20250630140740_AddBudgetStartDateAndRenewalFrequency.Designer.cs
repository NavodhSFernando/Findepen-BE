...
namespace FinDepen_Backend.Migrations
{
    ...
    [Migration("20250630140740_AddBudgetStartDateAndRenewalFrequency")]
    partial class AddBudgetStartDateAndRenewalFrequency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinDepen_Backend.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FinDepen_Backend.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FinDepen_Backend.Entities.RecurringTransaction", b =>
                {
                    b.HasOne("FinDepen_Backend.Entities.Transaction", null)
                        .WithOne()
                        .HasForeignKey("FinDepen_Backend.Entities.RecurringTransaction", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
